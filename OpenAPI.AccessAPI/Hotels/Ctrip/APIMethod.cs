...
using OpenAPI.AccessAPI.Hotels.Ctrip.Model;
using OpenAPI.AccessAPI.Hotels.Ctrip.Model.Request;
using OpenAPI.AccessAPI.Hotels.Ctrip.Model.Response;
using OpenAPI.AccessAPI.Hotels.Ctrip.SDK;
using OpenAPI.AccessAPI.Hotels.Ctrip.Hotel.Model;
using OpenAPI.FrameWork.Common;

namespace OpenAPI.AccessAPI.Hotels.Ctrip
{
