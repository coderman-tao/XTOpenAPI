using OpenAPI.AccessAPI.Scenerys.LY.Model;
using OpenAPI.AccessAPI.Scenerys.LY.SDK;
using OpenAPI.FrameWork.Common;
using System;
...
namespace OpenAPI.AccessAPI.Scenerys.LY
{
   public class APIMethod
    {
        ...
        /// <returns></returns>
        public OpenAPI.AccessAPI.Scenerys.LY.Model.SceneryPrice GetSceneryPrice(int showDetail, List<int> ids)
        {
            ...
            doc.LoadXml(rs);
            return doc.SelectSingleNode("response/body").InnerXml.XmlToEntity<OpenAPI.AccessAPI.Scenerys.LY.Model.SceneryPrice>();
            //return rs;
        }
        ...
        /// <returns></returns>
        public OpenAPI.AccessAPI.Scenerys.LY.Model.NearByScenerys GetNearbyScenery(int SceneryId, int page, int pageSize)
        {
            ...
            return rs.XmlToEntity<OpenAPI.AccessAPI.Scenerys.LY.Model.NearByScenerys>(); ;
        }
        ...
        //    var obj = str.XmlToEntity<OpenAPI.AccessAPI.Scenerys.LY.Model.sceneryList>();
        //    if (obj != null)
        //    {
        //        try
        //        {
        ...
        //                var model = str.XmlToEntity<OpenAPI.AccessAPI.Scenerys.LY.Model.sceneryList>();
